...
#from Dreambooth.version_1.loading_concept_image import DreamBoothDataset, PromptDataset 
...
def parse_args(input_args=None):
    ...
    parser.add_argument(
        "--output_dir",
        type=str,
        default="/data1/StableDiffusion/Dreambooth/rick",
...
def main(args): 
    ...
    ## Checkout the representation of the number with datatype 
    ...
    ## Future Extend Version using VeLO Optimizer 
    ...
    def save_weights(step): 
        if accelerator.is_main_process: 
            ...
            if args.save_sample_prompt is not None: 
                ...
                if torch.cuda.is_available(): 
                    torch.cuda.empty_cache()
            print(f"[*] weight save at {save_dir}")
