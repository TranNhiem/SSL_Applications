...
generate_data = COCO_synthetic_Dataset(
    image_root='/home/rick/synthetic_data/coco_synthetic/', ann_root='/home/rick/synthetic_data/coco_synthetic/')


# CoCo Val2014 Caption data with Length of 566747
print(generate_data.__len__())
for i in range(41500, 50000):
